      ...
      <form role="form" action="<?php echo base_url('category/create') ?>" method="post" id="createForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="order_id" name="order_id" autocomplete="off">
          </div>
    ...
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('order/update') ?>" method="post" id="updateForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="brand_name">Order ID</label>
            <input type="text" class="form-control" id="edit_order_id" name="edit_order_id"autocomplete="off">
          </div>
...
$(document).ready(function() {
  ...
  manageTable = $('#manageTable').DataTable({
    'ajax': base_url + 'order/fetchOrderData',
    'order': []
  });
...
{
  $.ajax({
    url: base_url + 'order/fetchOrderDataById/'+id,
    type: 'post',
    dataType: 'json',
    success:function(response) {
