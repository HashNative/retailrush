...
class Products extends User_Controller
{
    ...
    public function search($search=null)
    {
        ...
        $product_data = $this->model_products->getProductFilteredData($search);
            $result = array();
        ...
        if($search){
            ...
            $this->render_template('searchresult', $this->data);
    ...
    */
    public function index()
    {
        ...
        $this->render_admin_template('admin/products/index', $this->data);
    }
    ...
    */
    public function create()
    {
        ...
        if ($this->form_validation->run() == TRUE) {
           ...
           // $parent_category=$this->model_category->getParentCategory(json_encode($this->input->post('category')));;
            $data = array(
            ...
            $this->render_admin_template('admin/products/create', $this->data);
        }
    }
    ...
    public function update($product_id)
    {
        ...
        if ($this->form_validation->run() == TRUE) {
         ...
         //   $parent_category=$this->model_category->getParentCategory(json_encode($this->input->post('category')));;
            ...
            $this->data['product_data'] = $product_data;
            $this->render_admin_template('admin/products/edit', $this->data);
        }
    }
